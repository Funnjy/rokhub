            ...
            <div className="main">
                <div className="welcome">
                    ...
                    <div>
                        ...
                        Ты можешь сам подать заявку о миграции, выставив свою кандидатуру, либо сам найти свой новый дом из уже существующих предложений.
                ...
                <div className="main__board">
                    <div className="card">
                        <div className="card__text_green">Игроков: <span className="card__text_bold">10000</span></div>
                    </div>
                    <div className="card">
                        <div className="card__text_green">Альянсов: <span className="card__text_bold">10000</span></div>
                    </div>
                </div>
            </div>
        );
